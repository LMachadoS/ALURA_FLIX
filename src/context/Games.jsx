...
const gamesApiUrl = 'https://my-json-server.typicode.com/LMachadoS/aluraflix-api/games'
const categoriesApiUrl = 'https://my-json-server.typicode.com/LMachadoS/alura-flix-apii-categories'
